...
| :--------------------------------------------------------------: | :------------------------------------------------------------------: | :------------------------------------------------------------: |
| ![Tampilan Halaman Utama Bakul](public/Screenshots/HomePage.png) | ![Tampilan Halaman Direktori UMKM](public/Screenshots/Directory.png) | ![Tampilan Halaman Detail UMKM](public/Screenshots/Detail.png) |
