        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 xl:col-span-6">
            ...
            <div className="lg:sticky lg:top-24">
              <h2 className="text-3xl sm:text-3xl md:text-5xl lg:text-4xl xl:text-5xl font-anton font-normal tracking-[-2%] text-[#081F36] mb-4 sm:mb-5 lg:mb-6 leading-tight max-w-full lg:max-w-[90%]">
                MENJADI WADAH BAGI UMKM TERBAIK NEGERI
              </h2>

              <p className="text-[#515151] text-[12px] sm:text-lg lg:text-base xl:text-lg leading-relaxed mb-6 sm:mb-8 max-w-full lg:max-w-[85%]">
              ...
              <CircleExpandButton
                href="/directory"
                className="max-w-[160px] sm:max-w-xs md:max-w-[210px]"
              />
            </div>
          </div>
